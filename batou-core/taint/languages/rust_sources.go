...
func (c *RustCatalog) Sources() []taint.SourceDef {
	return []taint.SourceDef{
		...
		},
		{
			...
			Category:    taint.SrcUserInput,
			Language:    rules.LangRust,
			Pattern:     `rocket::form::FromForm|Query<`,
			ObjectType:  "rocket",
			MethodName:  "Query<T>",
		...
		// --- Axum short-form extractors (no extract:: prefix) ---
		{
			...
			Category:    taint.SrcUserInput,
			Language:    rules.LangRust,
			Pattern:     `axum::extract::Query|Query\(`,
			ObjectType:  "axum",
		...
		},
		{
			...
			Category:    taint.SrcUserInput,
			Language:    rules.LangRust,
			Pattern:     `axum::extract::Path|Path\(`,
			ObjectType:  "axum",
		...
		},
		{
			...
			Category:    taint.SrcUserInput,
			Language:    rules.LangRust,
			Pattern:     `axum::extract::Json|Json\(`,
			ObjectType:  "axum",
		...
		},
		{
			...
			Category:    taint.SrcUserInput,
			Language:    rules.LangRust,
			Pattern:     `axum::extract::Form|Form\(`,
			ObjectType:  "axum",
