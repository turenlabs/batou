...
var jsSinks = []taint.SinkDef{
	...
	{ID: "js.mongoose.find.tainted", Category: taint.SnkSQLQuery, Pattern: `\.find\s*\(`, ObjectType: "", MethodName: "find", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB find with user-controlled query object", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.aggregate.tainted", Category: taint.SnkSQLQuery, Pattern: `\.aggregate\s*\(`, ObjectType: "", MethodName: "aggregate", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB aggregate pipeline with tainted data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.findone", Category: taint.SnkSQLQuery, Pattern: `\.findOne\s*\(`, ObjectType: "", MethodName: "findOne", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB findOne with user-controlled query", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.update", Category: taint.SnkSQLQuery, Pattern: `\.update\s*\(`, ObjectType: "", MethodName: "update", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB update with tainted query/data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.updateone", Category: taint.SnkSQLQuery, Pattern: `\.updateOne\s*\(`, ObjectType: "", MethodName: "updateOne", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB updateOne with tainted query/data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.updatemany", Category: taint.SnkSQLQuery, Pattern: `\.updateMany\s*\(`, ObjectType: "", MethodName: "updateMany", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB updateMany with tainted query/data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.deleteone", Category: taint.SnkSQLQuery, Pattern: `\.deleteOne\s*\(`, ObjectType: "", MethodName: "deleteOne", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB deleteOne with tainted query", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.deletemany", Category: taint.SnkSQLQuery, Pattern: `\.deleteMany\s*\(`, ObjectType: "", MethodName: "deleteMany", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB deleteMany with tainted query", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.findoneandupdate", Category: taint.SnkSQLQuery, Pattern: `\.findOneAndUpdate\s*\(`, ObjectType: "", MethodName: "findOneAndUpdate", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB findOneAndUpdate with tainted query/data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.findoneanddelete", Category: taint.SnkSQLQuery, Pattern: `\.findOneAndDelete\s*\(`, ObjectType: "", MethodName: "findOneAndDelete", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB findOneAndDelete with tainted query", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.insertone", Category: taint.SnkSQLQuery, Pattern: `\.insertOne\s*\(`, ObjectType: "", MethodName: "insertOne", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB insertOne with tainted data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.insertmany", Category: taint.SnkSQLQuery, Pattern: `\.insertMany\s*\(`, ObjectType: "", MethodName: "insertMany", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB insertMany with tainted data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
	{ID: "js.mongoose.replaceone", Category: taint.SnkSQLQuery, Pattern: `\.replaceOne\s*\(`, ObjectType: "", MethodName: "replaceOne", DangerousArgs: []int{0}, Severity: rules.High, Description: "MongoDB replaceOne with tainted data", CWEID: "CWE-943", OWASPCategory: "A03:2021-Injection"},
