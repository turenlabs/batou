...
func main() {
	...
	testutil.MustFindRule(t, result, "BATOU-AUTH-002")
}
...
app.get('/admin/dashboard', authenticate, (req, res) => {
	...
	result := testutil.ScanContent(t, "/app/routes.ts", content)
	testutil.MustNotFindRule(t, result, "BATOU-AUTH-002")
}
...
func TestAUTH005_ShortMinLength(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/auth.go", content)
	testutil.MustFindRule(t, result, "BATOU-AUTH-005")
}
...
func TestAUTH005_Safe_GoodLength(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/auth.go", content)
	testutil.MustNotFindRule(t, result, "BATOU-AUTH-005")
}
...
// --- BATOU-AUTH-007: Privilege Escalation ---
...
int main() {
	...
	testutil.MustFindRule(t, result, "BATOU-AUTH-007")
}
