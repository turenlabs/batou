...
func TestDjango001_Settings_Vulnerable(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-DJANGO-001")
}
...
func TestDjango001_Safe_Settings(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/settings.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-DJANGO-001")
}
...
func TestDjango002_ORM_SQLi_Fixture(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-DJANGO-002")
}
...
func TestDjango002_Safe_Parameterized(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-DJANGO-002")
}
...
func TestDjango003_SafeFilter(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustFindRule(t, result, "GTSS-FW-DJANGO-003")
}
...
func TestDjango003_Safe_Escaped(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-DJANGO-003")
}
...
func TestDjango004_CsrfExempt(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustFindRule(t, result, "GTSS-FW-DJANGO-004")
}
...
func TestDjango004_Safe_NoCsrfExempt(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-DJANGO-004")
}
...
func TestDjango005_MassAssign_POST(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustFindRule(t, result, "GTSS-FW-DJANGO-005")
}
...
func TestDjango005_Safe_ExplicitFields(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-DJANGO-005")
}
...
func TestFlask001_Misconfig_Fixture(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-FLASK-001")
}
...
func TestFlask001_Safe_Fixture(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/app.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-FLASK-001")
}
...
func TestFlask002_Safe_StaticTemplate(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-FLASK-002")
}
...
func TestFlask003_Safe_SecureFilename(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-FLASK-003")
}
...
func TestFlask004_Markup_Fixture(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/app.py", content)
	testutil.MustFindRule(t, result, "GTSS-FW-FLASK-004")
}
...
func TestFlask004_Safe_Escape(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views.py", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-FLASK-004")
}
...
func TestRails001_HTMLSafe_Variable(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-001")
}
...
func TestRails001_HTMLSafe_StringLiteral_Safe(t *testing.T) {
	...
	result := testutil.ScanContent(t, "/app/views/show.rb", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-RAILS-001")
}

// --- GTSS-FW-RAILS-002: render inline SSTI ---
...
func TestRails002_RenderInline_Variable(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-002")
}
...
// --- GTSS-FW-RAILS-003: constantize RCE ---
...
func TestRails003_Constantize_Params(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-003")
}
...
// --- GTSS-FW-RAILS-004: params.permit! ---
...
func TestRails004_PermitBang(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-004")
}

func TestRails004_PermitWithFields_Safe(t *testing.T) {
	content := `params.require(:user).permit(:name, :email)`
	result := testutil.ScanContent(t, "/app/controllers/users_controller.rb", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-RAILS-004")
}
...
func TestRails005_DebugTrue(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-005")
}
...
// --- GTSS-FW-RAILS-006: ActiveRecord SQL injection ---

func TestRails006_WhereParamsInterp(t *testing.T) {
	content := `User.where("name = '#{params[:name]}'")`
	result := testutil.ScanContent(t, "/app/controllers/users_controller.rb", content)
	testutil.MustFindRule(t, result, "GTSS-FW-RAILS-006")
}
...
func TestRails006_WhereHash_Safe(t *testing.T) {
	content := `User.where(name: params[:name])`
	result := testutil.ScanContent(t, "/app/controllers/users_controller.rb", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-RAILS-006")
}
...
func TestLaravel001_DBRawVariable(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-LARAVEL-001")
}
...
func TestLaravel002_BladeUnescaped(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-LARAVEL-002")
}

func TestLaravel002_BladeEscaped_Safe(t *testing.T) {
	content := `{{ $userContent }}`
	result := testutil.ScanContent(t, "/resources/views/profile.blade.php", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-LARAVEL-002")
}

// --- GTSS-FW-LARAVEL-003: Mass assignment ---

func TestLaravel003_CreateAll(t *testing.T) {
	content := `User::create($request->all());`
	result := testutil.ScanContent(t, "/app/Http/Controllers/UserController.php", content)
	testutil.MustFindRule(t, result, "GTSS-FW-LARAVEL-003")
}
...
// --- GTSS-FW-LARAVEL-006: Unserialize ---
...
func TestLaravel006_UnserializeRequest(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-LARAVEL-006")
}

// --- GTSS-FW-LARAVEL-007: Storage traversal ---
...
func TestLaravel007_StorageGet(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-LARAVEL-007")
}
...
// --- GTSS-FW-REACT-001: SSR with user input ---
...
`
	...
	testutil.MustFindRule(t, result, "GTSS-FW-REACT-001")
}
...
`
	result := testutil.ScanContent(t, "/app/server.tsx", content)
	testutil.MustNotFindRule(t, result, "GTSS-FW-REACT-001")
}
...
// --- GTSS-FW-REACT-002: ref innerHTML ---
...
func TestReact002_RefInnerHTML(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-REACT-002")
}

// --- GTSS-FW-REACT-003: Prop spreading ---
...
func TestReact003_SpreadUserInput(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-REACT-003")
}
...
// --- GTSS-FW-REACT-004: Dynamic script/iframe ---
...
func TestReact004_CreateElementScript(t *testing.T) {
	...
	testutil.MustFindRule(t, result, "GTSS-FW-REACT-004")
}
